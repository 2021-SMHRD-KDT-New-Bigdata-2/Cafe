...
<body>
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=a0848145c218c41d87cceb06f093d635"></script>
	<script>
...
if (navigator.geolocation) {
    ...
    navigator.geolocation.getCurrentPosition(function(position) {
        ...
        var locPosition = new kakao.maps.LatLng(lat, lon), // 마커가 표시될 위치를 geolocation으로 얻어온 좌표로 생성합니다
            message = '<div style="padding:5px;"><%=cafe_list.get(0).getCafeName()%>
		...
		<div class="col-md-12">
			<form action="#" method="post">
				<div class="container row" style="float: none; margin: 0 auto;">
					<div class="col-md-12">
						<div class="liston1">
							<img src="<%=cafe_list.get(0).getImage1()%>" alt="logo"
								style="width: 25%;">
							<p><%=cafe_list.get(0).getCafeName()%>
							</p>
							<p>
								주소 :
								<%=cafe_list.get(0).getCafeAddress()%>
							</p>
							<p>
								번호 :
								<%=cafe_list.get(0).getCafeTel()%>
							</p>
							<p>
								<a
									href="infoService?businessNumber=<%=cafe_list.get(0).getBusinessNumber()%>">상세보기</a>
							</p>
						</div>
					</div>
